namespace MineSweeper;
 ...
 class Minesweeper {
     ...
     static void Menu() {
         ...
         String[] menu1 = {"                                    ║      Hrať      ║", "                                    ║    Ako hrať    ║","                                    ║     Koniec     ║"};
         ...
         int menu3AktualSpot = 0;
         int menu3MaxPozicia = 4;
         ...
         while (true) {
             ...
             switch (keyInfo.Key) {
                 ...
                 case ConsoleKey.Enter:
                     ...
                     if (aktualMenu == 1 && aktualSpot == 0) { //Možnosť Začať hru
                         aktualMenu = 2;
                     } else if (aktualMenu == 1 && aktualSpot == 1) {
                         aktualMenu = 3;
                     } else if (aktualMenu == 1 && aktualSpot == 2) { // Možnosť Koniec
                         Environment.Exit(0);
                     } else if (aktualMenu == 2 && aktualSpot == 0) { // Možnosť Amatér
                         Console.Clear();
                         int[,] mines = GenerateMines(10, 9, 9);
                         Movement(10, 9, 9, mines);
                     } else if (aktualMenu == 2 && aktualSpot == 1) { // Možnosť Znalec
                         Console.Clear();
                     ...
                     } else if (aktualMenu == 2 && aktualSpot == 3) { // Možnosť Custom      
                         Console.Clear();
                         Console.ForegroundColor = ConsoleColor.Yellow;
                         Console.WriteLine("███╗   ███╗██╗███╗   ██╗███████╗███████╗██╗    ██╗███████╗███████╗██████╗ ███████╗██████╗");
                         Console.WriteLine("████╗ ████║██║████╗  ██║██╔════╝██╔════╝██║    ██║██╔════╝██╔════╝██╔══██╗██╔════╝██╔══██╗");
             ...
             } else if (aktualMenu == 3) {

                 while (aktualMenu == 3) {
                     if (menu3AktualSpot == 0) {
                         Console.Clear(); 
                         Console.ForegroundColor = ConsoleColor.Yellow;
                         Console.WriteLine("╔══════════════════════════════════════════════════════════════════════════╗"); //76 - 2
                         Console.WriteLine("║              V hre sú v hernom poli náhodne rozložené míny,              ║"); //46
                         Console.WriteLine("║      ktoré je treba odhaliť pomocou nápovied na okolních políčkach.      ║"); //62
                         Console.WriteLine("║                          Odhal všetky a vyhraj!                          ║"); //22
                         Console.WriteLine("║ 1/5                                         Backspace pre návrat do menu ║");
                         Console.WriteLine("╚══════════════════════════════════════════════════════════════════════════╝");
                         Console.ResetColor();
                     } else if (menu3AktualSpot == 1) { 
                         Console.Clear();
                         Console.ForegroundColor = ConsoleColor.Blue;
                         Console.WriteLine("  ╔══════════════════════════════════════════════════════════════════════════════════════════╗"); // 86 - 2
                         Console.WriteLine("  ║                   Keď odhalíš pole tak sa na ňom nachádza číslo.                         ║"); //46
                         Console.WriteLine("  ║               0 - Pole je prázdne a v jeho okolí nie ke žiadna mína.                     ║");// 54
                         Console.WriteLine("  ║    1 - 8 - Pole je prázdne a v jeho okolí sa nachádza toľko mín koľko sa píše v poli.    ║"); //82
                         Console.WriteLine("  ║                                      9 - Mína                                            ║"); //8
                         Console.WriteLine("  ╚══════════════════════════════════════════════════════════════════════════════════════════╝");
                         Console. WriteLine();
                         Console.WriteLine("╔═════════════════════════════════════════════════════════════════════════════════════════════╗"); //91 - 2
                         Console.WriteLine("║                                     Príklad okolia:                                         ║"); //15
                         Console.WriteLine("║                                          X X X                                              ║"); //5
                         Console.WriteLine("║                                          X 1 X                                              ║"); //5
                         Console.WriteLine("║                                          X X X                                              ║"); //5
                         Console.WriteLine("║   V strede je číslo jedna čo znamená že v okolí ktoré je zobrazené sa nachádza jedna mína   ║"); //87
                         Console.WriteLine("║ 2/5                                                            Backspace pre návrat do menu ║"); //3
                         Console.WriteLine("╚═════════════════════════════════════════════════════════════════════════════════════════════╝");
                         Console.ResetColor();
                     } else if (menu3AktualSpot == 2) {
                         Console.Clear(); 
                         Console.ForegroundColor = ConsoleColor.Green;
                         Console.WriteLine("╔═══════════════════════════════════════════════════════════════════════╗"); 
                         Console.WriteLine("║  Logicky skús uhádnuť kde sú všetky míny a daj na tie miesta vlajky.  ║"); 
                         Console.WriteLine("║      Po tom čo položíš všetky vlajky použiť C pre overenie výhry      ║"); 
                         Console.WriteLine("║ 3/5                                      Backspace pre návrat do menu ║");//3
                         Console.WriteLine("╚═══════════════════════════════════════════════════════════════════════╝");
                         Console.ResetColor();
                     } else if (menu3AktualSpot == 3) {
                         Console.Clear();
                         Console.ForegroundColor = ConsoleColor.DarkCyan;
                         Console.WriteLine("╔═════════════════════════════════════════════════════╗"); //55 - 2
                         Console.WriteLine("║                    Šípky - pohyb                    ║");  // 13
                         Console.WriteLine("║      Enter - Potvrdiť možnosť / Odhalenie poľa      ║"); //41
                         Console.WriteLine("║                  P- položiť vlajku                  ║"); //17
                         Console.WriteLine("║                  C- overenie výhry                  ║"); //17
                         Console.WriteLine("║ 4/5                    Backspace pre návrat do menu ║");
                         Console.WriteLine("╚═════════════════════════════════════════════════════╝");
                         Console.ResetColor();
                     } else if (menu3AktualSpot == 4) {
                         Console.Clear();
                         Console.ForegroundColor = ConsoleColor.Red;
                         Console.WriteLine("╔══════════════════════════════════════╗"); //40 - 2
                         Console.WriteLine("║      Amatér - Pole 9x9 & 10 mín      ║"); //26
                         Console.WriteLine("║     Znalec - Pole 16x16 & 40 mín     ║"); //28
                         Console.WriteLine("║     Expert - Pole 16x30 & 99 mín     ║"); // 28
                         Console.WriteLine("║ 5/5     Backspace pre návrat do menu ║"); //4
                         Console.WriteLine("╚══════════════════════════════════════╝"); 
                         Console.ResetColor();
                     }
                     ...
                     switch (keyInf.Key) {
                         case ConsoleKey.RightArrow:
                             if (menu3AktualSpot == menu3MaxPozicia) {
                                 continue;
                             } else {
                                 menu3AktualSpot++;  
                             }
